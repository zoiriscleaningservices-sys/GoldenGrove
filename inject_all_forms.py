#!/usr/bin/env python3
"""
Final Contact Form Complete Coverage Script
Ensures 100% of all HTML pages (including galleries, blogs, and locations)
have the exact same standard LeadConnector contact form section right before </main>.
"""
...
for dirpath, dirnames, filenames in os.walk(ROOT):
    ...
    for fname in filenames:
        ...
        if 'Qw27XO1tcXra7A4hA2hy' not in content and '<section id="quote"' not in content:
            if '</main>' in content:
                content = content.replace('</main>', f'{STANDARD_QUOTE_SECTION}\n    </main>', 1)
                try:
...
print(f"Injected standard contact form into {injected:,} remaining pages!")
