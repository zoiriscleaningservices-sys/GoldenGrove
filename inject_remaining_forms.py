#!/usr/bin/env python3
"""
Inject standard contact form into gallery, blog, and location subpages
so that literally 100% of all pages across the website have the exact same contact form section.
"""
...
for dirpath, dirnames, filenames in os.walk(ROOT):
    ...
    for fname in filenames:
        ...
        if 'Qw27XO1tcXra7A4hA2hy' not in content:
            if '<!-- SITE-WIDE BOOK NOW & FREE QUOTE CTA BANNER -->' in content:
...
print(f"Injected standard form into {injected:,} remaining subpages!")
